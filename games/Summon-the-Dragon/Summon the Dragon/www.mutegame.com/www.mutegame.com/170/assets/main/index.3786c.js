...
function hackInject(gamecore) {
    ...
    <div id="hack-panel2" style="margin-top:4px;background-color: rgb(55, 65, 194);font-size:16px;line-height:20px; height: 20px;color:#fff;text-align:right">点击完全隐藏菜单<<<<<<</div>
        <style>
            .hack-btn {
                width: 100%;
                height: 24px;
    ...
    el += `<div style="background-color: rgb(55, 65, 194); height: 20px;color:#fff;font-size:12px;">如果遇到任何BUG比如卡死请刷新<br><br><a href="https://github.com/NNOSS999">N2O PRODUCTIONS主页</a></div>`
    ...
    */
    ...
    document.querySelector("#hack-panel2").onclick = function() {
        const panel = window.consoleDiv
        if (window.panelStatus === true) {
